...
-- 2. Delete triggers to clean up galleries when entities are deleted
-- 3. get_related_galleries RPC for gallery inheritance
-- 4. Backfill script for existing entities
--
-- Note: Auto-creation is now handled by the ensure_entity_gallery RPC
-- (see migration 20260405000050_fix_system_gallery_rls.sql)
--
...
-- ============================================================================
-- 2. Delete triggers to clean up system galleries when entities are deleted
-- ============================================================================
