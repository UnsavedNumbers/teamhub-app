-- Migration: Update sync_org_license_summary to sync trial_start
-- Description: Ensures sync_org_license_summary syncs trial_start field from org_licenses to organizations
-- Date: 2026-02-22

BEGIN;

-- ============================================================================
-- STEP 1: Update sync_org_license_summary function to include trial_start
-- ============================================================================
...
BEGIN
  ...
  SET
    ...
    license_trial_start = lic.trial_start, -- Sync trial_start field
