-- Migration: Add excluded_from_discovery to admin_feature_entitlements_list view
-- Description: Adds excluded_from_discovery column to the admin view so it can be filtered
-- Date: 2026-02-23

BEGIN;

-- ============================================================================
-- STEP 1: Update admin_feature_entitlements_list view to include excluded_from_discovery
-- ============================================================================
