-- ============================================================================
-- Add Role Management RPCs for Platform Admins
-- ============================================================================
-- This migration creates platform admin RPCs for managing user roles in
-- organizations. These RPCs wrap the existing add_org_role and remove_org_role
-- helper functions and add proper permission checks, validation, and event logging.
-- ============================================================================
...
COMMENT ON FUNCTION admin_add_org_role IS 'Platform admin RPC: Add organization role to user. Requires ops_admin or super_admin.';
COMMENT ON FUNCTION admin_remove_org_role IS 'Platform admin RPC: Remove organization role from user. Requires ops_admin or super_admin.';
COMMENT ON FUNCTION admin_change_org_role IS 'Platform admin RPC: Change user role in organization. Requires ops_admin or super_admin.';
