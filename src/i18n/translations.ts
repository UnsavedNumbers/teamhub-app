...
export const en = {
    ...
    videoLibrary: {
        ...
        edit: {
            ...
            loadFailed: 'Failed to load edit options',
        },
        ...
        notes: {
            ...
            invalidTimestamp: 'Invalid format (M:SS)',
            timestampLabel: 'Timestamp (MM:SS)',
            captureTime: 'Capture Time',
            placeholder: 'Type your coaching observation...',
            assignAndVisibility: 'Assign & Visibility',
            assignToAthletes: 'Assign to Athletes',
            visibility: 'Visibility',
            addAtTimestamp: 'Add Note at {{timestamp}}',
            count: '{{count}} note',
            count_plural: '{{count}} notes',
            sortByTime: 'By Time',
            sortNewest: 'Newest',
            authorFallback: 'Coach',
            created: 'Note added',
            createFailed: 'Failed to add note',
        },
        ...
        athletes: {
            ...
            removeConfirm: 'Remove this athlete from the video?',
            loadFailed: 'Failed to load athletes',
            updateFailed: 'Failed to update athlete links',
            updated: 'Athlete links updated',
            removed: 'Athlete removed',
        },
        ...
        tags: {
            ...
            tagNamePlaceholder: 'e.g., Zone Defense',
            videoCount: '{{count}} video',
            videoCount_plural: '{{count}} videos',
            tagFallback: 'TAG',
        ...
        comments: {
            ...
            userFallback: 'User',
            deletedMessage: '[This comment has been removed]',
        ...
        bookmarks: {
            ...
            deleteConfirm: 'Delete bookmark?',
            createFailed: 'Failed to add bookmark',
        ...
        shareLink: {
            ...
            emailRecipientsPlaceholder: 'email1@example.com, email2@example.com',
            emailRecipientsHint: 'Comma-separated email addresses to notify (optional)',
            creating: 'Creating...',
...
export const es = {
    common: {
        ...
        athletes: {
            ...
            noAthletes: 'Sin atletas vinculados',
            linkAthletes: 'Vincular atletas',
            linkAllTeam: 'Vincular todo el equipo',
            linkType: 'Tipo de vinculo',
            linkTypes: {
                featured: 'Destacado',
                appears: 'Aparece',
                highlight: 'Resaltado',
            },
            athletesSelected: '{{count}} seleccionados',
            saveLinks: 'Guardar vinculos',
            alreadyLinked: 'Ya vinculado',
            removeConfirm: 'Quitar este atleta del video?',
            loadFailed: 'No se pudieron cargar los atletas',
            updateFailed: 'No se pudieron actualizar los vinculos',
            updated: 'Vinculos de atletas actualizados',
            removed: 'Atleta eliminado',
        },
        notes: 'NOTAS',
        home: 'Inicio',
    ...
    videoLibrary: {
        ...
        edit: {
            ...
            loadFailed: 'No se pudieron cargar las opciones de edicion',
        },
        delete: {
            title: 'Eliminar video',
            messageWithTitle: 'Seguro que deseas eliminar \"{{title}}\"? Esta accion no se puede deshacer.',
        },
        allTeams: 'Todos los equipos',
        details: {
        ...
        notes: {
            ...
            scopes: {
                ...
                guardians: 'Compartir con tutores',
                all: 'Todos',
            },
            closePanel: 'Cerrar panel de notas',
            invalidTimestamp: 'Formato invalido (M:SS)',
            timestampLabel: 'Marca de tiempo (MM:SS)',
            captureTime: 'Capturar tiempo',
            placeholder: 'Escribe tu observacion de entrenamiento...',
            assignAndVisibility: 'Asignar y visibilidad',
            assignToAthletes: 'Asignar a atletas',
            visibility: 'Visibilidad',
            addAtTimestamp: 'Agregar nota en {{timestamp}}',
            count: '{{count}} nota',
            count_plural: '{{count}} notas',
            sortByTime: 'Por tiempo',
            sortNewest: 'Mas recientes',
            authorFallback: 'Entrenador',
            created: 'Nota agregada',
            createFailed: 'No se pudo agregar la nota',
        },
        athletes: {
            title: 'Atletas vinculados',
            noAthletes: 'Sin atletas vinculados',
        ...
        tags: {
            ...
            tagNamePlaceholder: 'ej., Defensa en zona',
            videoCount: '{{count}} video',
            videoCount_plural: '{{count}} videos',
            tagFallback: 'ETIQUETA',
            createFailed: 'No se pudo crear la etiqueta',
            updateFailed: 'No se pudieron actualizar las etiquetas',
            updated: 'Etiquetas actualizadas',
        },
        comments: {
            title: 'Comentarios',
            noCommentsMessage: 'Inicia una conversacion sobre este video.',
            writeComment: 'Escribe un comentario...',
            postComment: 'Publicar',
            deleteComment: 'Eliminar',
            deleteConfirm: 'Seguro que deseas eliminar este comentario?',
            reply: 'Responder',
            ...
            deletedMessage: '[Este comentario fue eliminado]',
            createFailed: 'No se pudo publicar el comentario',
        ...
        bookmarks: {
            title: 'Marcadores',
            noBookmarksMessage: 'Agrega marcas de tiempo para navegar rapidamente este video.',
            addBookmark: 'Agregar marcador',
            bookmarkLabel: 'Etiqueta (opcional)',
            bookmarkLabelPlaceholder: 'ej., Gran jugada',
            jumpTo: 'Ir a',
            atTimestamp: 'En {{timestamp}}',
            deleteConfirm: 'Eliminar marcador?',
            createFailed: 'No se pudo agregar el marcador',
            deleteFailed: 'No se pudo eliminar el marcador',
        },
        shareLink: {
            title: 'Compartir video',
            description: 'Genera un enlace seguro para compartir este video.',
            generateLink: 'Generar enlace',
            copyLink: 'Copiar enlace',
            linkCopied: 'Enlace copiado',
            expiration: 'Expiracion del enlace',
            ...
            emailRecipients: 'Correos (opcional)',
            emailRecipientsPlaceholder: 'correo1@ejemplo.com, correo2@ejemplo.com',
            emailRecipientsHint: 'Correos separados por coma para notificar (opcional)',
            creating: 'Creando...',
            noActiveLinks: 'Sin enlaces activos',
            createOne: 'Crear uno',
            downloadBadge: 'DESCARGA',
            views: '{{count}} vista',
            views_plural: '{{count}} vistas',
            sharedWith: 'Compartido con',
            createFailed: 'No se pudo crear el enlace',
            revokeConfirm: 'Seguro que deseas revocar este enlace compartido? Quien lo tenga ya no tendra acceso.',
            revokeFailed: 'No se pudo revocar el enlace',
        },
        thumbnail: {
            updated: 'Miniatura actualizada correctamente',
            failed: 'No se pudo actualizar la miniatura',
        },
        noNotes: 'Sin notas aún',
    },
