...
export const fakeFeeAssignments: FakeFeeAssignment[] = [
    ...
    { id: 'fa-001', fee_id: FEE_SPRING_SOCCER_REG_ID, child_id: CHILD_EMMA_JOHNSON_ID, status: 'paid', amount_due_cents: 15000, amount_paid_cents: 15000, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-20T00:00:00Z', updated_at: '2024-02-10T00:00:00Z' },
    ...
    { id: 'fa-007', fee_id: FEE_SPRING_BB_REG_ID, child_id: CHILD_LIAM_JOHNSON_ID, status: 'paid', amount_due_cents: 12500, amount_paid_cents: 12500, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-25T00:00:00Z', updated_at: '2024-02-15T00:00:00Z' },
    { id: 'fa-008', fee_id: FEE_SPRING_BB_REG_ID, child_id: CHILD_NOAH_SMITH_ID, status: 'paid', amount_due_cents: 12500, amount_paid_cents: 12500, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-25T00:00:00Z', updated_at: '2024-02-18T00:00:00Z' },
    { id: 'fa-009', fee_id: FEE_SPRING_BB_REG_ID, child_id: CHILD_ETHAN_WILLIAMS_ID, status: 'unpaid', amount_due_cents: 12500, amount_paid_cents: 0, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-25T00:00:00Z', updated_at: '2024-01-25T00:00:00Z' },
    { id: 'fa-010', fee_id: FEE_SPRING_BB_REG_ID, child_id: CHILD_ISABELLA_RODRIGUEZ_ID, status: 'waived', amount_due_cents: 12500, amount_paid_cents: 0, discount_cents: 0, discount_reason: null, waived_at: '2024-02-01T00:00:00Z', waived_reason: 'Financial assistance program', created_at: '2024-01-25T00:00:00Z', updated_at: '2024-02-01T00:00:00Z' },
    ...
    // Uniform Fee - Soccer
    { id: 'fa-014', fee_id: FEE_UNIFORM_SOCCER_ID, child_id: CHILD_EMMA_JOHNSON_ID, status: 'paid', amount_due_cents: 7500, amount_paid_cents: 7500, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-25T00:00:00Z', updated_at: '2024-02-10T00:00:00Z' },
    { id: 'fa-015', fee_id: FEE_UNIFORM_SOCCER_ID, child_id: CHILD_SOPHIA_CHEN_ID, status: 'paid', amount_due_cents: 7500, amount_paid_cents: 7500, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-25T00:00:00Z', updated_at: '2024-02-08T00:00:00Z' },

    // Equipment Fee - Basketball
    { id: 'fa-016', fee_id: FEE_EQUIPMENT_BB_ID, child_id: CHILD_LIAM_JOHNSON_ID, status: 'paid', amount_due_cents: 2500, amount_paid_cents: 2500, discount_cents: 0, discount_reason: null, waived_at: null, waived_reason: null, created_at: '2024-01-28T00:00:00Z', updated_at: '2024-02-15T00:00:00Z' },
]
...
export const fakePayments: FakePayment[] = [
    ...
    { id: 'pay-002', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-014', amount_cents: 7500, currency: 'usd', status: 'succeeded', stripe_payment_intent_id: 'pi_demo_002', payment_method: 'card', paid_at: '2024-02-10T14:31:00Z', refunded_at: null, notes: null, created_at: '2024-02-10T14:31:00Z', updated_at: '2024-02-10T14:31:00Z' },
    ...
    { id: 'pay-004', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-015', amount_cents: 7500, currency: 'usd', status: 'succeeded', stripe_payment_intent_id: 'pi_demo_004', payment_method: 'card', paid_at: '2024-02-08T11:00:00Z', refunded_at: null, notes: null, created_at: '2024-02-08T11:00:00Z', updated_at: '2024-02-08T11:00:00Z' },

    // Partial payment for Aiden Patel
    { id: 'pay-005', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-003', amount_cents: 7500, currency: 'usd', status: 'succeeded', stripe_payment_intent_id: 'pi_demo_005', payment_method: 'card', paid_at: '2024-02-20T09:00:00Z', refunded_at: null, notes: 'First installment', created_at: '2024-02-20T09:00:00Z', updated_at: '2024-02-20T09:00:00Z' },
    ...
    { id: 'pay-009', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-007', amount_cents: 12500, currency: 'usd', status: 'succeeded', stripe_payment_intent_id: 'pi_demo_009', payment_method: 'card', paid_at: '2024-02-15T11:00:00Z', refunded_at: null, notes: null, created_at: '2024-02-15T11:00:00Z', updated_at: '2024-02-15T11:00:00Z' },
    ...
    { id: 'pay-011', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-008', amount_cents: 12500, currency: 'usd', status: 'succeeded', stripe_payment_intent_id: 'pi_demo_011', payment_method: 'check', paid_at: '2024-02-18T00:00:00Z', refunded_at: null, notes: 'Check #1234', created_at: '2024-02-18T00:00:00Z', updated_at: '2024-02-18T00:00:00Z' },

    // Failed payment example
    { id: 'pay-012', org_id: DEMO_ORG_A_ID, fee_assignment_id: 'fa-009', amount_cents: 12500, currency: 'usd', status: 'failed', stripe_payment_intent_id: 'pi_demo_012_failed', payment_method: 'card', paid_at: null, refunded_at: null, notes: 'Card declined - insufficient funds', created_at: '2024-02-28T09:00:00Z', updated_at: '2024-02-28T09:00:00Z' },
]
