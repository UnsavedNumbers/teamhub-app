...
export const EVENT_U10_SOCCER_PRACTICE_PAST_1_ID = 'event-u10-soccer-practice-past-001'
export const EVENT_U10_SOCCER_PRACTICE_PAST_2_ID = 'event-u10-soccer-practice-past-002'
export const EVENT_U10_SOCCER_GAME_PAST_1_ID = 'event-u10-soccer-game-past-001'
export const EVENT_U12_SOCCER_PRACTICE_PAST_1_ID = 'event-u12-soccer-practice-past-001'
export const EVENT_U10_BB_PRACTICE_PAST_1_ID = 'event-u10-bb-practice-past-001'
export const EVENT_U10_BB_GAME_PAST_1_ID = 'event-u10-bb-game-past-001'
export const EVENT_U12_BB_PRACTICE_PAST_1_ID = 'event-u12-bb-practice-past-001'
export const EVENT_U14_SOCCER_GAME_PAST_1_ID = 'event-u14-soccer-game-past-001'
// Additional future events for more calendar depth
export const EVENT_U10_SOCCER_PRACTICE_3_ID = 'event-u10-soccer-practice-003'
export const EVENT_U12_SOCCER_GAME_1_ID = 'event-u12-soccer-game-001'
export const EVENT_U12_BB_GAME_1_ID = 'event-u12-bb-game-001'
export const EVENT_U14_SOCCER_PRACTICE_1_ID = 'event-u14-soccer-practice-001'
...
export const fakeEvents: CalendarEvent[] = [
    ...
    // ── Past events (for attendance history) ────────────────────────────────
    {
        id: EVENT_U10_SOCCER_PRACTICE_PAST_1_ID,
        team_id: TEAM_U10_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U10 Soccer Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, -7), 17, 0),
        end_time: setTime(addDays(today, -7), 18, 30),
        arrival_time: setTime(addDays(today, -7), 16, 45),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 4',
        notes: 'Passing drills and shooting practice.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 15), updated_at: getDateInCurrentYear(2, 15),
        team: { id: TEAM_U10_SOCCER_ID, name: 'U10 Lightning', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    {
        id: EVENT_U10_SOCCER_PRACTICE_PAST_2_ID,
        team_id: TEAM_U10_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U10 Soccer Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, -4), 17, 0),
        end_time: setTime(addDays(today, -4), 18, 30),
        arrival_time: setTime(addDays(today, -4), 16, 45),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 4',
        notes: 'Defensive formations and set pieces.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 18), updated_at: getDateInCurrentYear(2, 18),
        team: { id: TEAM_U10_SOCCER_ID, name: 'U10 Lightning', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    {
        id: EVENT_U10_SOCCER_GAME_PAST_1_ID,
        team_id: TEAM_U10_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'Game vs. Northside FC',
        type: 'game' as EventType,
        start_time: setTime(addDays(today, -10), 10, 0),
        end_time: setTime(addDays(today, -10), 11, 30),
        arrival_time: setTime(addDays(today, -10), 9, 30),
        timezone: 'America/New_York',
        location: 'Lincoln Park - Field 1',
        notes: 'Result: W 3-1. Emma scored twice!',
        uniform_notes: 'Home jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 1), updated_at: getDateInCurrentYear(2, 22),
        team: { id: TEAM_U10_SOCCER_ID, name: 'U10 Lightning', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    {
        id: EVENT_U12_SOCCER_PRACTICE_PAST_1_ID,
        team_id: TEAM_U12_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U12 Soccer Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, -5), 18, 0),
        end_time: setTime(addDays(today, -5), 19, 30),
        arrival_time: setTime(addDays(today, -5), 17, 45),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 3',
        notes: 'Tournament prep drills.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 15), updated_at: getDateInCurrentYear(2, 15),
    ...
    {
        id: EVENT_U10_BB_PRACTICE_PAST_1_ID,
        team_id: TEAM_U10_BASKETBALL_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U10 Hawks Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, -6), 16, 30),
        end_time: setTime(addDays(today, -6), 18, 0),
        arrival_time: setTime(addDays(today, -6), 16, 15),
        timezone: 'America/New_York',
        location: 'Riverside Community Center - Gym A',
        notes: 'Dribbling fundamentals and layup drills.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Basketball shoes',
        weather_dependent: false, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 15), updated_at: getDateInCurrentYear(2, 15),
        team: { id: TEAM_U10_BASKETBALL_ID, name: 'U10 Hawks', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    ...
    {
        id: EVENT_U10_BB_GAME_PAST_1_ID,
        team_id: TEAM_U10_BASKETBALL_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'Game vs. Central Ballers',
        type: 'game' as EventType,
        start_time: setTime(addDays(today, -9), 14, 0),
        end_time: setTime(addDays(today, -9), 15, 30),
        arrival_time: setTime(addDays(today, -9), 13, 30),
        timezone: 'America/New_York',
        location: 'Central Community Center',
        notes: 'Result: L 22-28. Great team effort!',
        uniform_notes: 'Away jersey', equipment_notes: 'Basketball shoes',
        weather_dependent: false, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 1), updated_at: getDateInCurrentYear(2, 18),
        team: { id: TEAM_U10_BASKETBALL_ID, name: 'U10 Hawks', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    {
        id: EVENT_U12_BB_PRACTICE_PAST_1_ID,
        team_id: TEAM_U12_BASKETBALL_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U12 Eagles Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, -8), 17, 0),
        end_time: setTime(addDays(today, -8), 18, 30),
        arrival_time: setTime(addDays(today, -8), 16, 45),
        timezone: 'America/New_York',
        location: 'Riverside Community Center - Gym B',
        notes: 'Defense and pick-and-roll concepts.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Basketball shoes',
        weather_dependent: false, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 15), updated_at: getDateInCurrentYear(2, 15),
    ...
    {
        id: EVENT_U14_SOCCER_GAME_PAST_1_ID,
        team_id: TEAM_U14_SOCCER_ELITE_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'League Game vs. Metro United',
        type: 'game' as EventType,
        start_time: setTime(addDays(today, -11), 11, 0),
        end_time: setTime(addDays(today, -11), 13, 0),
        arrival_time: setTime(addDays(today, -11), 10, 30),
        timezone: 'America/New_York',
        location: 'Metro Sports Complex - Field 1',
        notes: 'Result: W 2-0. Solid defensive performance.',
        uniform_notes: 'Away jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(2, 1), updated_at: getDateInCurrentYear(2, 14),
        team: { id: TEAM_U14_SOCCER_ELITE_ID, name: 'U14 Elite Storm', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    // ── Additional future events ──────────────────────────────────────────────
    {
        id: EVENT_U10_SOCCER_PRACTICE_3_ID,
        team_id: TEAM_U10_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U10 Soccer Practice',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, 9), 17, 0),
        end_time: setTime(addDays(today, 9), 18, 30),
        arrival_time: setTime(addDays(today, 9), 16, 45),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 4',
        notes: 'Post-game review and new play introduction.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(3, 1), updated_at: getDateInCurrentYear(3, 1),
        team: { id: TEAM_U10_SOCCER_ID, name: 'U10 Lightning', org_id: DEMO_ORG_A_ID },
        season: { id: SEASON_SPRING_CURRENT_ID, name: getSpringSeasonName() },
    },
    {
        id: EVENT_U12_SOCCER_GAME_1_ID,
        team_id: TEAM_U12_SOCCER_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'Game vs. Riverside Hawks',
        type: 'game' as EventType,
        start_time: setTime(addDays(today, 7), 11, 0),
        end_time: setTime(addDays(today, 7), 12, 30),
        arrival_time: setTime(addDays(today, 7), 10, 30),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 1',
        notes: 'Home game! Great crowd turnout expected.',
        uniform_notes: 'Home jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(3, 1), updated_at: getDateInCurrentYear(3, 1),
    ...
    {
        id: EVENT_U12_BB_GAME_1_ID,
        team_id: TEAM_U12_BASKETBALL_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'Game vs. Eastside Rockets',
        type: 'game' as EventType,
        start_time: setTime(addDays(today, 8), 15, 0),
        end_time: setTime(addDays(today, 8), 16, 30),
        arrival_time: setTime(addDays(today, 8), 14, 30),
        timezone: 'America/New_York',
        location: 'Eastside Community Center - Gym',
        notes: 'Away game. Playoff seeding implications!',
        uniform_notes: 'Away jersey', equipment_notes: 'Basketball shoes',
        weather_dependent: false, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(3, 1), updated_at: getDateInCurrentYear(3, 1),
    ...
    {
        id: EVENT_U14_SOCCER_PRACTICE_1_ID,
        team_id: TEAM_U14_SOCCER_ELITE_ID,
        season_id: SEASON_SPRING_CURRENT_ID,
        title: 'U14 Elite Practice — Tournament Prep',
        type: 'practice' as EventType,
        start_time: setTime(addDays(today, 3), 18, 30),
        end_time: setTime(addDays(today, 3), 20, 30),
        arrival_time: setTime(addDays(today, 3), 18, 15),
        timezone: 'America/New_York',
        location: 'Riverside Sports Complex - Field 1',
        notes: 'State Cup preparation. Full-intensity practice.',
        uniform_notes: 'Practice jersey', equipment_notes: 'Shin guards, cleats',
        weather_dependent: true, external_link: null, is_cancelled: false,
        cancellation_reason: null, cancelled_at: null, cancelled_by_user_id: null, created_by_user_id: null,
        created_at: getDateInCurrentYear(3, 1), updated_at: getDateInCurrentYear(3, 1),
