...
export const RouteKeys = {
    ...
    PORTAL_CALENDAR_CREATE: 'portal.calendarCreate',
    ...
    PORTAL_HUDDLES: 'portal.huddles',
    PORTAL_ANNOUNCEMENTS: 'portal.announcements',
    PORTAL_ANNOUNCEMENT_DETAIL: 'portal.announcementDetail',
    PORTAL_MESSAGES: 'portal.messages',
    PORTAL_PAYMENTS: 'portal.payments',
    PORTAL_PAYMENT_DETAIL: 'portal.paymentDetail',
    ...
    PORTAL_TRYOUT_DETAIL: 'portal.tryoutDetail',
    PORTAL_TRYOUT_REGISTRATIONS: 'portal.tryoutRegistrations',
    ...
    ADMIN_ANNOUNCEMENT_DETAIL: 'admin.announcements.detail',
    ADMIN_TRAVEL: 'admin.travel.list',
    ADMIN_TRYOUTS: 'admin.tryouts.list',
    ADMIN_TRYOUTS_CREATE: 'admin.tryouts.create',
    ADMIN_TRYOUT_DETAIL: 'admin.tryouts.detail',
    ADMIN_TRYOUTS_ASSIGNED: 'admin.tryouts.assigned',
    ADMIN_TRYOUTS_REGISTRATIONS: 'admin.tryouts.registrations',
    ADMIN_TRYOUTS_EVALUATORS: 'admin.tryouts.evaluators',
    ADMIN_TRYOUTS_EVALUATION: 'admin.tryouts.evaluation',
