-- Fix can_edit_video to allow platform admins to edit any video
-- Platform admins should be able to edit/delete videos from any org
-- VALIDATED: organization_members has org_id, user_id, role (NO is_active column)
