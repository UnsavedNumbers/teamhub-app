-- Fix search_entities function - teams table does not have logo_url column
-- Teams should return NULL for logo_url field
...
COMMENT ON FUNCTION public.search_entities(TEXT, VARCHAR[], INTEGER) IS 'Search for public entities (orgs, teams, athletes) with relevance scoring. Only returns public entities. Fixed: teams do not have logo_url column.';
