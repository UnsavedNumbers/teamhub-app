-- ============================================================================
-- Ensure ensure_entity_gallery function exists and works correctly
-- ============================================================================
-- This migration fixes potential issues from the previous migration where
-- duplicate content may have caused the function creation to fail.
-- ============================================================================

-- Ensure the function is created with the correct implementation
...
'Creates or retrieves the system-generated gallery for an entity. Runs with elevated privileges to bypass RLS for gallery creation.';
